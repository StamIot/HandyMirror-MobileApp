    ...
    return (
        <View style={styles.DetectePhotoFaceScreenContainer}>
            ...
            <View style={styles.faceIDContainer}>
                <Text style={{ color: Utilities.color.light.antiquewhite }}>Veuillez vous tenir de face devant la caméra</Text>
            ...
            <View style={styles.lastContainer}>
                <Pressable style={styles.btn} onPress={() => navigation.navigate('DetectePhotoLeftProfileScreen')}>
